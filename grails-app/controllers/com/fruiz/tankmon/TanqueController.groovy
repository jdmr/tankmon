    ...
    def crea() {
        ...
        try {
            Tanque.withTransaction {
                ...
                tanque.capacidadLleno = new BigDecimal(params.capacidadLleno).multiply(new BigDecimal('0.01'))
                tanque.capacidadVacio = new BigDecimal(params.capacidadVacio).multiply(new BigDecimal('0.01'))
                tanque.latitud = new BigDecimal(params.latitud)
                tanque.longitud = new BigDecimal(params.longitud)
                tanque.precaucion = new BigDecimal(params.precaucion).multiply(new BigDecimal('0.01'))
                tanque.alerta = new BigDecimal(params.alerta).multiply(new BigDecimal('0.01'))
                ...
                xtanque.capacidadLleno = new BigDecimal(params.capacidadLleno).multiply(new BigDecimal('0.01'))
                xtanque.capacidadVacio = new BigDecimal(params.capacidadVacio).multiply(new BigDecimal('0.01'))
                xtanque.latitud = new BigDecimal(params.latitud)
                xtanque.longitud = new BigDecimal(params.longitud)
                xtanque.precaucion = new BigDecimal(params.precaucion).multiply(new BigDecimal('0.01'))
                xtanque.alerta = new BigDecimal(params.alerta).multiply(new BigDecimal('0.01'))
